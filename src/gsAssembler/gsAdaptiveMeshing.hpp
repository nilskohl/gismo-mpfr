...
T gsAdaptiveMeshing<T>::_totalError(const boxMapType & elements)
{
    ...
    T totalError = std::accumulate(elements.begin(),elements.end(),static_cast<T>(0),accumulate_error_ptr);
    return totalError;
}
...
gsAdaptiveMeshing<T>::_markFraction_impl( const boxMapType & elements, const std::vector<gsHBoxCheck<2,T> *> predicates, typename gsAdaptiveMeshing<T>::HBoxContainer & elMarked) const
{
                    ...
                    (const index_t & index)
    {
        ...
        T siblingError = std::accumulate(sibs.begin(),sibs.end(),static_cast<T>(0),accumulate_error);
...
gsAdaptiveMeshing<T>::_markFraction_impl( const boxMapType & elements, const std::vector<gsHBoxCheck<2,T> *> predicates, typename gsAdaptiveMeshing<T>::HBoxContainer & elMarked) const
{
                    ...
                    (const index_t & index)
    {
        ...
        T neighborhoodError = std::accumulate(neighborhood.begin(),neighborhood.end(),static_cast<T>(0),accumulate_error);
...
gsAdaptiveMeshing<T>::_markProjectedFraction_impl( const boxMapType & elements, const std::vector<gsHBoxCheck<2,T> *> predicates, typename gsAdaptiveMeshing<T>::HBoxContainer & elMarked) const
{
                    ...
                    (const index_t & index)
    {
        ...
        HBoxContainer siblings(sibs);
        T siblingSetBack = std::accumulate(sibs.begin(),sibs.end(),static_cast<T>(0),accumulate_improvement);
...
gsAdaptiveMeshing<T>::_markProjectedFraction_impl( const boxMapType & elements, const std::vector<gsHBoxCheck<2,T> *> predicates, typename gsAdaptiveMeshing<T>::HBoxContainer & elMarked) const
{
                    ...
                    (const index_t & index)
    {
        ...
        _setContainerProperties(neighborhood);
        T neighborhoodImprovement = std::accumulate(neighborhood.begin(),neighborhood.end(),static_cast<T>(0),accumulate_improvement);
